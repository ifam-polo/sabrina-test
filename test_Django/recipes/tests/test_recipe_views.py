...
class RecipeViewsTest(TestCase):
        # verificar se a class da view da home está sendo renderizada quando acessada pela url
    ...
    # verificar se a class view da category está sendo renderizada quando acessada pela url
   ...
   # def test_recipe_category_view_return_status_code_404_if_no_recipes_found(self):
    ...
    # verificar se a class view da detail está sendo renderizada quando acessada pela url
    def test_recipe_detail_views_function_is_correct(self):
        view = resolve(reverse('recipes:recipe', kwargs={'pk':1}))
        self.assertIs(view.func.view_class, views.RecipeDetail)
        
        
    # verificar se a class view da search está sendo renderizada quando acessada pela url
    ...
    # verificar se a view da search está retornando 404
